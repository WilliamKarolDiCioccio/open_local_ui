...
class TTSStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Synthesize = channel.unary_unary(
                '/TTS/Synthesize',
                request_serializer=server__pb2.TTSRequest.SerializeToString,
                response_deserializer=server__pb2.TTSResponse.FromString,
...
def add_TTSServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Synthesize': grpc.unary_unary_rpc_method_handler(
                    servicer.Synthesize,
                    request_deserializer=server__pb2.TTSRequest.FromString,
                    response_serializer=server__pb2.TTSResponse.SerializeToString,
            ),
    }
...
class TTS(object):
    ...
    def Synthesize(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/TTS/Synthesize',
            server__pb2.TTSRequest.SerializeToString,
            server__pb2.TTSResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
